...
export const categoryTaglines: Record<MenuCategory, string> = {
  ...
  Noodle: "Hand-stirred classics, every order.",
  "Fried Rice": "Smoky, fragrant, never dry.",
...
export const menu: MenuItem[] = [
  ...
  // ===== Noodle =====
  {
    ...
    description:
      "Our most-ordered dish. Stir-fried rice noodles with tamarind, fish sauce, palm sugar, egg, bean sprout, scallion, and crushed peanut. Bright, balanced, and the version we're known for.",
